...
_DIRECT_CLAUSE_PATTERNS = (
    ...
    r"que (peux[- ]tu|pouvez[- ]vous|sais[- ]tu|savez[- ]vous) faire( pour (moi|nous))?",
    r"qu'est-ce que (tu|vous) (peux|pouvez|sais|savez) faire( pour (moi|nous))?",
    r"que fais[- ]tu",
